...
| Archivo | Qué es | Págs. |
|---|---|---|
| `diagnostico-v2-ejemplo.html` | Primer diagnóstico, todos los documentos leídos | 4 |
| `diagnostico-v2-ejemplo_mes2.html` | Segundo diagnóstico, comparado contra la línea base | 5 |
| `diagnostico-v2-ejemplo_sin-costeo.html` | Primer diagnóstico con solo recetario y menú | 4 |
