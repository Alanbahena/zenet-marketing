...
| 4 | **Pricing structure 4 tiers** (Esencial · Pro · Multi-Sitio · Enterprise) — WhatsApp en todas diferenciado por service level · **AI agents Phase 1 incluidos full cross-tier** (integrated MVP · NO gating sustractivo · cf. §6.7) · agency framing preserved | Decisión del subfolder · anclada en `02-features-y-scope/00-fase-1-mvp-scope.md` v0.1 |
