...
│   │   │   └── _archive/
│   │   ├── 04-go-to-market/                ✓ v0.1 — 12 docs (00-06 + 07 comunidad · 08 learnings · 09 bitácora · 10 scorecard · 11 ICP de hipótesis + edición de campo) + _tracking/ + _export/
│   │   │   └── _archive/
...
│   │       └── _archive/
│   ├── _sop/                               empty
│   ├── _templates/                         6 archivos (run-sheets · guiones · mensajes · debrief) + _export/ (PDF de la edición de campo)
│   └── skills/                             empty
│
# ═══════════════════════════════════════════════════════════════════
...
│   ├── _context/
│   │   ├── 01-landing-page/                ✓ v3.3 EN VIVO — 4 docs (00 estrategia v0.3 · 01 copy v0.4 · 02 prototipo v3.3 · 03 hablemos v0.1)
│   │   │   └── _archive/
│   │   └── 02-demo/                        ✓ v0.1 — 1 doc (estrategia y copy de /demo · tag v3.1)
...
| ICP de hipótesis — edición de campo (versión de 12 páginas para la mesa: qué es la Fase A · las 6 hipótesis en plano · el experimento · el ICP · el filtro · dolor y deseo · a quién no · en la mesa I y II · el marcador · cierre · **fuente del PDF** en `_export/icp-fase-a_edicion-de-campo.pdf` · build: pandoc + Chrome headless, documentado en la cabecera) | 🚧 draft v0.1 | `Product Strategy/_context/04-go-to-market/11-icp-hipotesis-fase-a_edicion-de-campo.md` |
...
| Página /demo · estrategia y copy (**la antesala del análisis y la puerta a la app — ya NO "la Etapa 1 del camino"** · EN VIVO tag `v3.1`, **v0.2 armada en la rama `v4`** · flujo documentos → análisis → **PDF** → *ya dentro*, la primera factura por WhatsApp (**paso 04**) · el reloj acotado a 01→03 · la letra honesta en *qué corre hoy / qué todavía no* · 13 decisiones canónicas · los 8 bloques) | ✓ active **v0.2** | `SEO and Content/_context/02-demo/00-estrategia-y-copy.md` |
