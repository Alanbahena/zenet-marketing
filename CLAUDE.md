...
| **Product Strategy / 06-experience-y-roadmap** | ✓ **1 spec v1.0 + 1 nota** | **`01-diagnostico-v2-spec.md` v1.0 (2026-09-21) — el rediseño del reporte de diagnóstico del onboarding, cerrado con el fundador bloque por bloque:** eje = las preguntas del dueño · 4 págs (tu operación en una página · lo que sale de tus documentos · tu camino en orden · el mes que viene y el detalle) · **dos índices** (el sistema de la cocina · *qué tanto se puede enseñar sin una persona clave*) · regla de tres lecturas y de píldoras · tres orígenes de dato (documento · declarado · sector) · el espejo *"lo que nos dijiste y lo que vimos"* · camino en dos tiempos (capturas · rutinas) + mapa de la 1.0 · línea base y *"lo que se movió"* del mes 2 · plantilla con/sin documento · **§8 contrato de generación para los agentes · §9 el asistente del diagnóstico**. Mocks HTML en `_mock/diagnostico-v2/` (3 versiones). Handoff al repo de producción. + `00-cs-as-agents-vision-nota.md` v0.1-nota (CS-as-Agents vision · NO Phase 1) |
| **— EXECUTION LAYER —** | | |
...
### Diagnóstico v2 (producto · 2026-09-21)
...
│   │   │   └── _archive/
│   │   └── 06-experience-y-roadmap/        ✓ 1 spec v1.0 (diagnóstico v2 · handoff a producción) + _mock/diagnostico-v2/ + 1 nota (CS-as-agents vision)
│   │       └── _archive/
│   ├── _sop/                               empty
...
| **Diagnóstico v2 — spec del reporte** (el rediseño del reporte de diagnóstico del onboarding · por qué se rediseña (8 defectos del actual) · 10 principios · 4 páginas bloque por bloque con cálculo, origen y copy · dos índices · regla de píldoras · el espejo problema↔evidencia · camino en dos tiempos + mapa de la 1.0 · mes 2 "lo que se movió desde tu línea base" · variante sin documentos · 3 preguntas nuevas del onboarding · **contrato de generación para agentes** · **asistente del diagnóstico** · descartes con razón · `[Alan verifica]`) | ✓ active v1.0 | `Product Strategy/_context/06-experience-y-roadmap/01-diagnostico-v2-spec.md` · mocks en `_mock/diagnostico-v2/` |
