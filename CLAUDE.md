...
| **Product Strategy / 02-features-y-scope** | 🚧 Active v0.1 — 1 doc completed | `00-fase-1-mvp-scope.md` v0.1 cerrado 2026-05-26 · 12 secciones · 8 capabilities canonical Phase 1 (6 Essential + 2 High value) · acceptance criteria operacional checkable · scope boundaries IN vs OUT explícito · 6 decisiones log con rationale · risk management (creep · cut · dependency · Cohort 1 emergency) · critical path E5→E2→E1→E4 con E2 foundational hub dual-role clarified · engineering handoff context (NO dicta implementation) · launch readiness Go/No-Go criteria · 7 hipótesis. Pending: 01-fase-2-roadmap-hipotesis · 02-feature-prioritization |
