...
- **Branding Fase A update CERRADO 2026-05-22 (transition checklist Market Research → Branding completada):**
  - ✅ `vocabulario.md` v1.0 → v1.1 — 10 updates (§5.2 agency framing rewrite · §5.4 conceptos propios expandidos · NEW §2.6 Cumplimiento y fiscal · NEW §2.7 Tecnología operativa friendly · §2.1+§2.5 VoC additions · §3 tech additions · §4.4 NEW AI hype prohibidas · §6 traducción · §9 glossary expandido a ~95 entries).
  - ✅ `posicionamiento.md` v1.1 → v1.2 — 9 updates (§1 declaración refinada · §3 ICP arquetípico + contable + anti-ICP cultural + buying committee dynamics · §4 diferenciadores reframe a 7 en 3 clusters · §5 mapa competitivo white space + TRUE incumbent reframe + timeline · §6 anti-positions · §7 pricing arbitrage Lente 2 70-100x + research backbone + timing pointer · §8 path fix + changelog).
  - ✅ `personalidad-y-arquetipo.md` v1.0 → v1.1 — 6 updates light pass (§2 sous chef refuerzo + brigada cognitiva analogy + VoC validation · §3 Sabio refuerzo research backbone · §4 Anna validators network · §6.1 singular→agency naming · §6.2 NEW WhatsApp interface example · §7 2 anti-positions añadidos · §Notas + frontmatter + changelog).
  - **Fase A complete:** Branding ahora sincronizado con Market Research v0.1 findings + research backbone integrado + agency-as-SaaS framing propagado consistently en los 3 docs (`vocabulario.md` + `posicionamiento.md` + `personalidad-y-arquetipo.md`) + sales motion + WhatsApp uso #3 + anti-positions críticos documentados.
  ...
  - **Siguiente:** arranca Paso 2 Product Strategy (`00-marco-y-metodologia/00-marco-product-strategy.md` v1.0 · methodology choices VPD primary + JTBD overlay + Kano).
