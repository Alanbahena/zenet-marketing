...
- **Reglas de contenido de la landing (canónicas desde 2026-09-02):** **cero cifras** en la página —ni de impacto ni de mercado; los datos son munición de deck, LinkedIn y venta, donde se cita fuente y año— · **cero colores de alerta** (no existe rojo ni ámbar en ninguna superficie del producto; la tensión se marca con peach `#F4DED0` y se apaga al volver la calma teal) · **nunca "falta de X"** (su sistema funciona: se sostiene con él; decirle inestable/desordenado/ineficiente es ataque a identidad) · **los agentes no se nombran** (Zenet es uno, también en las animaciones). → `SEO and Content/_context/01-landing-page/00-estrategia-y-estructura.md` §4
