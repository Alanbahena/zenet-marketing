...
| **SEO and Content** | ✓ **Landing v3 EN VIVO** 2026-08-07 | **Landing v3 en producción (`zenetapp.com` · tag `v3.0`)** — narrativa Sinek + raíz "el caos no es el precio" · 9 secciones · pieza estrella "El camino" (3 etapas animadas + consulta chat) · hero sólido · regla "los componentes hablan". Gate levantado por decisión del fundador (⚠️ deuda de producto: onboarding + análisis real — el copy habla en presente). 3 docs sincronizados: `00-estrategia-y-estructura` **v0.2** + `01-copy` **v0.3** + `02-prototipo-y-diseno` **v3.0** (incluye QA/lecciones WebKit). Artefacto vivo = repo `zenet-landing` |
...
- **Landing = fuente de verdad del diseño** en spec markdown (`02-prototipo-y-diseno.md` **v2.0**); el artefacto vivo es el **repo `zenet-landing`** (GitHub + Vercel · producción `zenetapp.com` · era Claude Design cerrada). Version control: git tags (`v1.0`/`v2.0`) + `lab/` para experimentos + `_archive/` en los specs. → `SEO and Content/_context/01-landing-page/02-prototipo-y-diseno.md`
...
│   │   │   └── _archive/
│   │   ├── 04-go-to-market/                ✓ v0.1 — 7 docs (00 marco · 01 GTM playbook · 02 digital distribution · 03 outreach · 04 sales motion · 05 channel/partner · 06 plan activación/validación Fase A)
│   │   │   └── _archive/
...
| Landing page · prototipo y diseño (spec v2 · repo `zenet-landing` + Vercel = artefacto vivo en `zenetapp.com` · tokens :root con acento teal · Onest+Hanken · grid 12-col 1280 · 11 secciones · componentes v2 (stepper · chips · strip anti-POS · burbujas) · 2 piezas animadas ("Cómo funciona" 5 beats + "En acción" reloj del día) · workflow lab/ + scripts python + git tags · assets v2 · portabilidad Next.js) | ✓ active v2.0 | `SEO and Content/_context/01-landing-page/02-prototipo-y-diseno.md` |
