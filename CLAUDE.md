...
| **Product Strategy / 02-features-y-scope** | 🚧 Active v0.1 — 2 docs completed | `00-fase-1-mvp-scope.md` v0.1 + `01-roadmap-hipotesis-fase-1.5-y-2.md` v0.1 cerrados 2026-05-26 · roadmap doc: 12 secciones · Phase 1.5 + Phase 2 bridge framework · **F7 POS API REMOVED post-research 2026-05-26** (research-validated structural barriers MX SMB) · F5 agentes especializados elevated priority #1 · F6 cumplimiento vía CFDI/PAC direct · F8 partner channel strategy parallel track NEW · F1-F4 reframed (periodic uploads · NOT real-time pipeline) · pricing transition framework conceptual (defer specifics to subfolder 03) · investor narrative corrected: product phases ≠ geographic phases · LATAM = Geographic Phase 5 + Series A (NOT product Phase 2) · partner channel target LIMAC + SYCA + PAC providers · 6 risk categories · 4 pivot scenarios. Pending: 02-feature-prioritization (último doc del subfolder) |
