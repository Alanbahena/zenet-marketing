...
- **Pendiente que este bloque deja escrito (`11` §8.3):** realinear `_templates/guion-conversacion-y-demo-fase-a.md` a §7 (y retirar *"Alineamiento"*) · `criterios-icp-y-design-partner` superseded para la Fase A · `plantilla-runsheet` con los 9 checks · `mensajes-outreach` al ICP nuevo. Y la retro fijó el orden: **doc 11 → copy v0.5 / landing v4 → proceso de ventas v0.1.**
...
│   │       └── _archive/
│   ├── _sop/                               empty
│   ├── _templates/                         6 archivos (run-sheets · guiones · debrief de sesión)
│   └── skills/                             empty
│
# ═══════════════════════════════════════════════════════════════════
...
| Bitácora semanal — Fase A (retro **por semana**, la más reciente arriba, formato fijo: foco previo · logros · qué funcionó · learnings · decisiones · **scorecard H1-H6** · foco de la semana siguiente · carril: **Notion ejecuta, la bitácora recuerda**) | ✓ active v0.5 | `Product Strategy/_context/04-go-to-market/09-bitacora-semanal-fase-a.md` |
...
| Landing page · estrategia y estructura (el trabajo de la página · 4 decisiones design-partner-trust/targeted/conversación-led/nombra-Zenet · audiencia · **narrativa v3 Sinek WHY→HOW→WHAT + raíz "el caos no es el precio" + hilo "cargar"** · arquitectura de 9 secciones · **Reglas v3.3 de contenido: cero cifras · cero colores de alerta · nunca "falta de X" · los agentes no se nombran** · historial v1→v2→v3→v3.3 · decisiones abiertas) | ✓ active **v0.3** | `SEO and Content/_context/01-landing-page/00-estrategia-y-estructura.md` |
| Landing page · copy por sección (el copy en vivo, sección por sección, **con el porqué de cada cambio y los vetos de vocabulario** · las 12 decisiones de la v3.3 · el log del build · la idea "Etapa 4 · Resultados" aparcada con gate) | ✓ active **v0.4** | `SEO and Content/_context/01-landing-page/01-copy.md` |
| Landing page · prototipo y diseño (spec de diseño · repo `zenet-landing` + Vercel = artefacto vivo · tokens :root teal · Onest+Hanken · grid 12-col 1280 · las 9 secciones · **la pieza estrella: 3 escenas animadas + la consulta** · **la escena del dominó v3.3** · componentes/patrones · inventario de scripts · **QA: harness `lab/_qa.html` · esquema SVG canónico anti-WebKit · headless sirve para estados finales, no para movimiento ni móvil** · Hablemos v0.4 en 3 pasos · assets · deploy) | ✓ active **v3.3** | `SEO and Content/_context/01-landing-page/02-prototipo-y-diseno.md` |
...
| Página /demo · estrategia y copy (antesala del análisis = Etapa 1 del camino · EN VIVO tag `v3.1` · flujo landing→/demo→app · decisiones canónicas: acceso cerrado · CTA doble · voz de marca · copy completo de los 7 bloques aprobado bloque por bloque) | ✓ active v0.1 | `SEO and Content/_context/02-demo/00-estrategia-y-copy.md` |
