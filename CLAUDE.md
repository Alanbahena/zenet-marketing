...
| **Product Strategy / 05-capital-y-finanzas** | 🚧 **Active v0.1 — 3 docs (README + operational + financial model scaffold)** | **Renamed 2026-05-30** desde `05-capital-y-fundraising` para acomodar financial modeling scope expansion. Docs: `README.md` v0.1 (scope + roadmap + Stage 1 vs Stage 2 trigger framework para Finance department split + external resources needed + 4 future docs scaffolded) + `01-operational-readiness-y-business-setup-phase-1.md` v0.1 (stack 7 identidades + PFAE→SAPI sequencing + Tier framework con intent confirmation gate Tier 2.0 + vendor stack + 5 compliance anchors + cost summary) + `02-financial-model-y-projections.md` v0.1-pre-draft scaffold (structural placeholder + 5 triggers para v0.1 construction + 12-section outline + data inputs needed + methodology references). Pendiente doc principal `00-funding-roadmap-y-milestones.md` con Path A vs B framework + futures (03 unit economics formal · 04 cash flow · 05 IR · 06 treasury) |
...
│   │   │   └── _archive/
│   │   ├── 03-oferta-y-pricing/            🚧 ACTIVE v0.1 — 4/6 docs cerrados (00 marco · 01 modelo comercial · 02 SF offer · 03 pricing tiers · pendientes 04 viabilidad + 05 WTP)
│   │   │   └── _archive/
│   │   ├── 04-go-to-market/                pending v0.1 — 4 docs (GTM playbook · outreach · sales motion · channel strategy)
│   │   │   └── _archive/
│   │   ├── 05-capital-y-finanzas/          🚧 ACTIVE v0.1 — 3 docs (README + 01 operational readiness + 02 financial model scaffold pre-draft) · pendiente 00 funding roadmap
│   │   │   └── _archive/
...
*Next planned update: cuando doc 04 viabilidad económica y COGS v0.1 cierre en `03-oferta-y-pricing/` (siguiente paso inmediato) · cuando subfolder `03-oferta-y-pricing/` cierre v0.1 completo (6 docs · 2 pendientes 04+05) · cuando doc principal `00-funding-roadmap-y-milestones.md` cierre v0.1 en `05-capital-y-finanzas/` · cuando `02-financial-model-y-projections.md` mueva de pre-draft a v0.1 (5 triggers cumplidos · ver scaffold doc) · cuando customer research transitions de `discovery-pre-PMF` a `design-partner-validation` etapa · cuando un new strategic decision belongs en section 4.*
