...
| **SEO and Content** | ✓ **Landing v2 EN VIVO** 2026-07-22 | **Landing v2 en producción (`zenetapp.com` · tag `v2.0`)** — acento teal · copy v2 · 11 secciones · animación "Cómo funciona" (tablero que corre solo) · sección "En acción" (6 momentos=6 áreas) · OG/favicon teal. 3 docs: `00-estrategia-y-estructura` v0.1 (pendiente refrescar con v2) + `01-copy` **v0.2** (copy v2 · v1 archivada) + `02-prototipo-y-diseno` **v2.0** (spec v2: repo git+Vercel · tokens teal · 2 piezas animadas · workflow lab/). Artefacto vivo = repo `zenet-landing` (era Claude Design cerrada) |
