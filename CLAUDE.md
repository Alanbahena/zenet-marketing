...
- **Subfolder `Product Strategy/_context/05-capital-y-fundraising/` 🚧 ACTIVE v0.1 (1 doc cerrado)** 2026-05-29:
...
| **Product Strategy / 03-oferta-y-pricing** | 🚧 **Active v0.1 — 1/6 docs completed** | `00-marco-de-oferta-y-pricing.md` v1.0 cerrado 2026-05-29 — 8 secciones · 5 frames estratégicos (value-based · arbitrage 70-100x · founder labor subsidy · agency-as-SaaS · competitive anchoring DUAL) · 10 decisiones canónicas heredadas (estructura 4 tiers Esencial $1,500 + Pro $1,999 + Multi-Sitio $1,799 + Enterprise · WhatsApp en todas diferenciado service level · agents Phase 1 full cross-tier · internal caps invisibles · add-ons Phase 1.5+ · contable siempre incluido) · 8 decisiones abiertas con triggers · 8 principios estructurales (dual COGS · tres pricing · internal vs visible caps · defensa multi-capa AI inference · tier differentiation ADITIVA NO sustractiva). Pendientes 5 docs: 01 modelo comercial → 02 programa Socio Fundador → 03 pricing tiers → 04 viabilidad económica → 05 WTP validation |
...
| **Product Strategy / 05-capital-y-fundraising** | 🚧 **Active v0.1 — 1 doc completed (operational readiness)** | `01-operational-readiness-y-business-setup-phase-1.md` v0.1 cerrado 2026-05-29 — 12 secciones · stack 7 identidades formales prerequisite · PFAE Phase 1 → SAPI pre-seed close canonical sequencing · Tier framework (Tier 1 NOW $8K · Tier 1.5 free preparations · Tier 2.0 paid commitments con **LOI gate** $30-50K · Tier 3 defer) · 60-day no-LOI pivot signal · lawyer + despacho + vendor stack (Stripe/Conekta · WhatsApp Business long-lead 6-12 sem · Anthropic enterprise) · 5 compliance anchors profundizados · cost summary 3 escenarios · timeline hipótesis Q3 2026 launch. Pendiente doc principal `00-funding-roadmap-y-milestones.md` con Path A vs B framework |
...
| Operational readiness y business setup Phase 1 (stack 7 identidades formales · PFAE→SAPI sequencing · Tier framework con LOI gate · lawyer + despacho + vendor stack · 5 compliance anchors · cost summary 3 escenarios · timeline hipótesis Q3 2026) | ✓ active v0.1 | `Product Strategy/_context/05-capital-y-fundraising/01-operational-readiness-y-business-setup-phase-1.md` |
...
*Next planned update: cuando doc 01 modelo comercial y términos v0.1 cierre en `03-oferta-y-pricing/` (siguiente paso inmediato) · cuando subfolder `03-oferta-y-pricing/` cierre v0.1 completo (6 docs) · cuando doc principal `00-funding-roadmap-y-milestones.md` cierre v0.1 en `05-capital-y-fundraising/` · cuando customer research transitions de `discovery-pre-PMF` a `design-partner-validation` etapa · cuando un new strategic decision belongs en section 4.*
